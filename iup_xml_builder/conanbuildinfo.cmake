...
###  PCRE2
#################
set(CONAN_PCRE2_ROOT "/Users/tim/.conan/data/pcre2/10.35/_/_/package/8727d9408e9a596f93f985319a7781850d615d02")
set(CONAN_INCLUDE_DIRS_PCRE2 "/Users/tim/.conan/data/pcre2/10.35/_/_/package/8727d9408e9a596f93f985319a7781850d615d02/include")
set(CONAN_LIB_DIRS_PCRE2 "/Users/tim/.conan/data/pcre2/10.35/_/_/package/8727d9408e9a596f93f985319a7781850d615d02/lib")
set(CONAN_BIN_DIRS_PCRE2 "/Users/tim/.conan/data/pcre2/10.35/_/_/package/8727d9408e9a596f93f985319a7781850d615d02/bin")
set(CONAN_RES_DIRS_PCRE2 )
set(CONAN_SRC_DIRS_PCRE2 )
set(CONAN_BUILD_DIRS_PCRE2 "/Users/tim/.conan/data/pcre2/10.35/_/_/package/8727d9408e9a596f93f985319a7781850d615d02/")
...
###  LIBXSLT
#################
set(CONAN_LIBXSLT_ROOT "/Users/tim/.conan/data/libxslt/1.1.34/_/_/package/47d5dc7a06d401f3d20698fbabc901c34c25720f")
set(CONAN_INCLUDE_DIRS_LIBXSLT "/Users/tim/.conan/data/libxslt/1.1.34/_/_/package/47d5dc7a06d401f3d20698fbabc901c34c25720f/include"
			"/Users/tim/.conan/data/libxslt/1.1.34/_/_/package/47d5dc7a06d401f3d20698fbabc901c34c25720f/include/libxslt")
set(CONAN_LIB_DIRS_LIBXSLT "/Users/tim/.conan/data/libxslt/1.1.34/_/_/package/47d5dc7a06d401f3d20698fbabc901c34c25720f/lib")
set(CONAN_BIN_DIRS_LIBXSLT "/Users/tim/.conan/data/libxslt/1.1.34/_/_/package/47d5dc7a06d401f3d20698fbabc901c34c25720f/bin")
set(CONAN_RES_DIRS_LIBXSLT )
set(CONAN_SRC_DIRS_LIBXSLT )
set(CONAN_BUILD_DIRS_LIBXSLT "/Users/tim/.conan/data/libxslt/1.1.34/_/_/package/47d5dc7a06d401f3d20698fbabc901c34c25720f/")
set(CONAN_FRAMEWORK_DIRS_LIBXSLT )
set(CONAN_LIBS_LIBXSLT exslt xslt)
set(CONAN_PKG_LIBS_LIBXSLT exslt xslt)
set(CONAN_SYSTEM_LIBS_LIBXSLT ws2_32)
set(CONAN_FRAMEWORKS_LIBXSLT )
set(CONAN_FRAMEWORKS_FOUND_LIBXSLT "")  # Will be filled later
set(CONAN_DEFINES_LIBXSLT "-DLIBXSLT_STATIC")
set(CONAN_BUILD_MODULES_PATHS_LIBXSLT )
# COMPILE_DEFINITIONS are equal to CONAN_DEFINES without -D, for targets
set(CONAN_COMPILE_DEFINITIONS_LIBXSLT "LIBXSLT_STATIC")

set(CONAN_C_FLAGS_LIBXSLT "")
set(CONAN_CXX_FLAGS_LIBXSLT "")
set(CONAN_SHARED_LINKER_FLAGS_LIBXSLT "")
set(CONAN_EXE_LINKER_FLAGS_LIBXSLT "")

# For modern cmake targets we use the list variables (separated with ;)
set(CONAN_C_FLAGS_LIBXSLT_LIST "")
set(CONAN_CXX_FLAGS_LIBXSLT_LIST "")
set(CONAN_SHARED_LINKER_FLAGS_LIBXSLT_LIST "")
set(CONAN_EXE_LINKER_FLAGS_LIBXSLT_LIST "")

# Apple Frameworks
conan_find_apple_frameworks(CONAN_FRAMEWORKS_FOUND_LIBXSLT "${CONAN_FRAMEWORKS_LIBXSLT}" "_LIBXSLT" "")
# Append to aggregated values variable
set(CONAN_LIBS_LIBXSLT ${CONAN_PKG_LIBS_LIBXSLT} ${CONAN_SYSTEM_LIBS_LIBXSLT} ${CONAN_FRAMEWORKS_FOUND_LIBXSLT})


#################
###  LIBARCHIVE
#################
set(CONAN_LIBARCHIVE_ROOT "/Users/tim/.conan/data/libarchive/3.5.1/_/_/package/3f0bbacbf31362a2dabb1f0bac063179e1bc0fb6")
set(CONAN_INCLUDE_DIRS_LIBARCHIVE "/Users/tim/.conan/data/libarchive/3.5.1/_/_/package/3f0bbacbf31362a2dabb1f0bac063179e1bc0fb6/include")
set(CONAN_LIB_DIRS_LIBARCHIVE "/Users/tim/.conan/data/libarchive/3.5.1/_/_/package/3f0bbacbf31362a2dabb1f0bac063179e1bc0fb6/lib")
set(CONAN_BIN_DIRS_LIBARCHIVE )
set(CONAN_RES_DIRS_LIBARCHIVE )
set(CONAN_SRC_DIRS_LIBARCHIVE )
set(CONAN_BUILD_DIRS_LIBARCHIVE "/Users/tim/.conan/data/libarchive/3.5.1/_/_/package/3f0bbacbf31362a2dabb1f0bac063179e1bc0fb6/")
set(CONAN_FRAMEWORK_DIRS_LIBARCHIVE )
set(CONAN_LIBS_LIBARCHIVE archive_static)
set(CONAN_PKG_LIBS_LIBARCHIVE archive_static)
set(CONAN_SYSTEM_LIBS_LIBARCHIVE )
set(CONAN_FRAMEWORKS_LIBARCHIVE )
set(CONAN_FRAMEWORKS_FOUND_LIBARCHIVE "")  # Will be filled later
set(CONAN_DEFINES_LIBARCHIVE )
set(CONAN_BUILD_MODULES_PATHS_LIBARCHIVE )
# COMPILE_DEFINITIONS are equal to CONAN_DEFINES without -D, for targets
set(CONAN_COMPILE_DEFINITIONS_LIBARCHIVE )

set(CONAN_C_FLAGS_LIBARCHIVE "")
set(CONAN_CXX_FLAGS_LIBARCHIVE "")
set(CONAN_SHARED_LINKER_FLAGS_LIBARCHIVE "")
set(CONAN_EXE_LINKER_FLAGS_LIBARCHIVE "")

# For modern cmake targets we use the list variables (separated with ;)
set(CONAN_C_FLAGS_LIBARCHIVE_LIST "")
set(CONAN_CXX_FLAGS_LIBARCHIVE_LIST "")
set(CONAN_SHARED_LINKER_FLAGS_LIBARCHIVE_LIST "")
set(CONAN_EXE_LINKER_FLAGS_LIBARCHIVE_LIST "")

# Apple Frameworks
conan_find_apple_frameworks(CONAN_FRAMEWORKS_FOUND_LIBARCHIVE "${CONAN_FRAMEWORKS_LIBARCHIVE}" "_LIBARCHIVE" "")
# Append to aggregated values variable
set(CONAN_LIBS_LIBARCHIVE ${CONAN_PKG_LIBS_LIBARCHIVE} ${CONAN_SYSTEM_LIBS_LIBARCHIVE} ${CONAN_FRAMEWORKS_FOUND_LIBARCHIVE})


#################
###  BZIP2
#################
set(CONAN_BZIP2_ROOT "/Users/tim/.conan/data/bzip2/1.0.8/_/_/package/7fd90bea7527b1753894a3cca37e19e981bbe9a6")
set(CONAN_INCLUDE_DIRS_BZIP2 "/Users/tim/.conan/data/bzip2/1.0.8/_/_/package/7fd90bea7527b1753894a3cca37e19e981bbe9a6/include")
set(CONAN_LIB_DIRS_BZIP2 "/Users/tim/.conan/data/bzip2/1.0.8/_/_/package/7fd90bea7527b1753894a3cca37e19e981bbe9a6/lib")
set(CONAN_BIN_DIRS_BZIP2 "/Users/tim/.conan/data/bzip2/1.0.8/_/_/package/7fd90bea7527b1753894a3cca37e19e981bbe9a6/bin")
set(CONAN_RES_DIRS_BZIP2 )
set(CONAN_SRC_DIRS_BZIP2 )
set(CONAN_BUILD_DIRS_BZIP2 "/Users/tim/.conan/data/bzip2/1.0.8/_/_/package/7fd90bea7527b1753894a3cca37e19e981bbe9a6/"
			"/Users/tim/.conan/data/bzip2/1.0.8/_/_/package/7fd90bea7527b1753894a3cca37e19e981bbe9a6/lib/cmake")
...
###  LIBXML2
#################
set(CONAN_LIBXML2_ROOT "/Users/tim/.conan/data/libxml2/2.9.10/_/_/package/597bccaad752a3c825c8149579ed0bf0e15b571a")
set(CONAN_INCLUDE_DIRS_LIBXML2 "/Users/tim/.conan/data/libxml2/2.9.10/_/_/package/597bccaad752a3c825c8149579ed0bf0e15b571a/include"
			"/Users/tim/.conan/data/libxml2/2.9.10/_/_/package/597bccaad752a3c825c8149579ed0bf0e15b571a/include/libxml2")
set(CONAN_LIB_DIRS_LIBXML2 "/Users/tim/.conan/data/libxml2/2.9.10/_/_/package/597bccaad752a3c825c8149579ed0bf0e15b571a/lib")
set(CONAN_BIN_DIRS_LIBXML2 )
set(CONAN_RES_DIRS_LIBXML2 )
set(CONAN_SRC_DIRS_LIBXML2 )
set(CONAN_BUILD_DIRS_LIBXML2 "/Users/tim/.conan/data/libxml2/2.9.10/_/_/package/597bccaad752a3c825c8149579ed0bf0e15b571a/"
			"/Users/tim/.conan/data/libxml2/2.9.10/_/_/package/597bccaad752a3c825c8149579ed0bf0e15b571a/lib/cmake")
...
set(CONAN_BUILD_MODULES_PATHS_LIBXML2 "/Users/tim/.conan/data/libxml2/2.9.10/_/_/package/597bccaad752a3c825c8149579ed0bf0e15b571a/lib/cmake/conan-official-libxml2-variables.cmake")
# COMPILE_DEFINITIONS are equal to CONAN_DEFINES without -D, for targets
...
###  ZLIB
#################
set(CONAN_ZLIB_ROOT "/Users/tim/.conan/data/zlib/1.2.11/_/_/package/e86d9266e0091537b02465f034f13e70aeefebfc")
set(CONAN_INCLUDE_DIRS_ZLIB "/Users/tim/.conan/data/zlib/1.2.11/_/_/package/e86d9266e0091537b02465f034f13e70aeefebfc/include")
set(CONAN_LIB_DIRS_ZLIB "/Users/tim/.conan/data/zlib/1.2.11/_/_/package/e86d9266e0091537b02465f034f13e70aeefebfc/lib")
set(CONAN_BIN_DIRS_ZLIB )
set(CONAN_RES_DIRS_ZLIB )
set(CONAN_SRC_DIRS_ZLIB )
set(CONAN_BUILD_DIRS_ZLIB "/Users/tim/.conan/data/zlib/1.2.11/_/_/package/e86d9266e0091537b02465f034f13e70aeefebfc/")
...
###  LIBICONV
#################
set(CONAN_LIBICONV_ROOT "/Users/tim/.conan/data/libiconv/1.16/_/_/package/e86d9266e0091537b02465f034f13e70aeefebfc")
set(CONAN_INCLUDE_DIRS_LIBICONV "/Users/tim/.conan/data/libiconv/1.16/_/_/package/e86d9266e0091537b02465f034f13e70aeefebfc/include")
set(CONAN_LIB_DIRS_LIBICONV "/Users/tim/.conan/data/libiconv/1.16/_/_/package/e86d9266e0091537b02465f034f13e70aeefebfc/lib")
set(CONAN_BIN_DIRS_LIBICONV "/Users/tim/.conan/data/libiconv/1.16/_/_/package/e86d9266e0091537b02465f034f13e70aeefebfc/bin")
set(CONAN_RES_DIRS_LIBICONV )
set(CONAN_SRC_DIRS_LIBICONV )
set(CONAN_BUILD_DIRS_LIBICONV "/Users/tim/.conan/data/libiconv/1.16/_/_/package/e86d9266e0091537b02465f034f13e70aeefebfc/")
...
set(CONAN_DEPENDENCIES pcre2 libxslt libarchive bzip2 libxml2 zlib libiconv)
...
set(CONAN_INCLUDE_DIRS "/Users/tim/.conan/data/pcre2/10.35/_/_/package/8727d9408e9a596f93f985319a7781850d615d02/include"
			"/Users/tim/.conan/data/libxslt/1.1.34/_/_/package/47d5dc7a06d401f3d20698fbabc901c34c25720f/include"
			"/Users/tim/.conan/data/libxslt/1.1.34/_/_/package/47d5dc7a06d401f3d20698fbabc901c34c25720f/include/libxslt"
			"/Users/tim/.conan/data/libarchive/3.5.1/_/_/package/3f0bbacbf31362a2dabb1f0bac063179e1bc0fb6/include"
			"/Users/tim/.conan/data/bzip2/1.0.8/_/_/package/7fd90bea7527b1753894a3cca37e19e981bbe9a6/include"
			"/Users/tim/.conan/data/libxml2/2.9.10/_/_/package/597bccaad752a3c825c8149579ed0bf0e15b571a/include"
			"/Users/tim/.conan/data/libxml2/2.9.10/_/_/package/597bccaad752a3c825c8149579ed0bf0e15b571a/include/libxml2"
			"/Users/tim/.conan/data/zlib/1.2.11/_/_/package/e86d9266e0091537b02465f034f13e70aeefebfc/include"
			"/Users/tim/.conan/data/libiconv/1.16/_/_/package/e86d9266e0091537b02465f034f13e70aeefebfc/include" ${CONAN_INCLUDE_DIRS})
set(CONAN_LIB_DIRS "/Users/tim/.conan/data/pcre2/10.35/_/_/package/8727d9408e9a596f93f985319a7781850d615d02/lib"
			"/Users/tim/.conan/data/libxslt/1.1.34/_/_/package/47d5dc7a06d401f3d20698fbabc901c34c25720f/lib"
			"/Users/tim/.conan/data/libarchive/3.5.1/_/_/package/3f0bbacbf31362a2dabb1f0bac063179e1bc0fb6/lib"
			"/Users/tim/.conan/data/bzip2/1.0.8/_/_/package/7fd90bea7527b1753894a3cca37e19e981bbe9a6/lib"
			"/Users/tim/.conan/data/libxml2/2.9.10/_/_/package/597bccaad752a3c825c8149579ed0bf0e15b571a/lib"
			"/Users/tim/.conan/data/zlib/1.2.11/_/_/package/e86d9266e0091537b02465f034f13e70aeefebfc/lib"
			"/Users/tim/.conan/data/libiconv/1.16/_/_/package/e86d9266e0091537b02465f034f13e70aeefebfc/lib" ${CONAN_LIB_DIRS})
set(CONAN_BIN_DIRS "/Users/tim/.conan/data/pcre2/10.35/_/_/package/8727d9408e9a596f93f985319a7781850d615d02/bin"
			"/Users/tim/.conan/data/libxslt/1.1.34/_/_/package/47d5dc7a06d401f3d20698fbabc901c34c25720f/bin"
			"/Users/tim/.conan/data/bzip2/1.0.8/_/_/package/7fd90bea7527b1753894a3cca37e19e981bbe9a6/bin"
			"/Users/tim/.conan/data/libiconv/1.16/_/_/package/e86d9266e0091537b02465f034f13e70aeefebfc/bin" ${CONAN_BIN_DIRS})
set(CONAN_RES_DIRS  ${CONAN_RES_DIRS})
set(CONAN_FRAMEWORK_DIRS  ${CONAN_FRAMEWORK_DIRS})
set(CONAN_LIBS pcre2-posix pcre2-8 pcre2-16 pcre2-32 exslt xslt archive_static bz2 xml2 zlib iconv charset ${CONAN_LIBS})
set(CONAN_PKG_LIBS pcre2-posix pcre2-8 pcre2-16 pcre2-32 exslt xslt archive_static bz2 xml2 zlib iconv charset ${CONAN_PKG_LIBS})
...
set(CONAN_BUILD_MODULES_PATHS "/Users/tim/.conan/data/libxml2/2.9.10/_/_/package/597bccaad752a3c825c8149579ed0bf0e15b571a/lib/cmake/conan-official-libxml2-variables.cmake" ${CONAN_BUILD_MODULES_PATHS})
set(CONAN_CMAKE_MODULE_PATH "/Users/tim/.conan/data/pcre2/10.35/_/_/package/8727d9408e9a596f93f985319a7781850d615d02/"
			"/Users/tim/.conan/data/libxslt/1.1.34/_/_/package/47d5dc7a06d401f3d20698fbabc901c34c25720f/"
			"/Users/tim/.conan/data/libarchive/3.5.1/_/_/package/3f0bbacbf31362a2dabb1f0bac063179e1bc0fb6/"
			"/Users/tim/.conan/data/bzip2/1.0.8/_/_/package/7fd90bea7527b1753894a3cca37e19e981bbe9a6/"
			"/Users/tim/.conan/data/bzip2/1.0.8/_/_/package/7fd90bea7527b1753894a3cca37e19e981bbe9a6/lib/cmake"
			"/Users/tim/.conan/data/libxml2/2.9.10/_/_/package/597bccaad752a3c825c8149579ed0bf0e15b571a/"
			"/Users/tim/.conan/data/libxml2/2.9.10/_/_/package/597bccaad752a3c825c8149579ed0bf0e15b571a/lib/cmake"
			"/Users/tim/.conan/data/zlib/1.2.11/_/_/package/e86d9266e0091537b02465f034f13e70aeefebfc/"
			"/Users/tim/.conan/data/libiconv/1.16/_/_/package/e86d9266e0091537b02465f034f13e70aeefebfc/" ${CONAN_CMAKE_MODULE_PATH})
...
macro(conan_define_targets)
    ...
    set(_CONAN_PKG_LIBS_LIBXSLT_DEPENDENCIES "${CONAN_SYSTEM_LIBS_LIBXSLT} ${CONAN_FRAMEWORKS_FOUND_LIBXSLT} CONAN_PKG::libxml2")
    string(REPLACE " " ";" _CONAN_PKG_LIBS_LIBXSLT_DEPENDENCIES "${_CONAN_PKG_LIBS_LIBXSLT_DEPENDENCIES}")
    conan_package_library_targets("${CONAN_PKG_LIBS_LIBXSLT}" "${CONAN_LIB_DIRS_LIBXSLT}"
                                  CONAN_PACKAGE_TARGETS_LIBXSLT "${_CONAN_PKG_LIBS_LIBXSLT_DEPENDENCIES}"
                                  "" libxslt)
    set(_CONAN_PKG_LIBS_LIBXSLT_DEPENDENCIES_DEBUG "${CONAN_SYSTEM_LIBS_LIBXSLT_DEBUG} ${CONAN_FRAMEWORKS_FOUND_LIBXSLT_DEBUG} CONAN_PKG::libxml2")
    string(REPLACE " " ";" _CONAN_PKG_LIBS_LIBXSLT_DEPENDENCIES_DEBUG "${_CONAN_PKG_LIBS_LIBXSLT_DEPENDENCIES_DEBUG}")
    conan_package_library_targets("${CONAN_PKG_LIBS_LIBXSLT_DEBUG}" "${CONAN_LIB_DIRS_LIBXSLT_DEBUG}"
                                  CONAN_PACKAGE_TARGETS_LIBXSLT_DEBUG "${_CONAN_PKG_LIBS_LIBXSLT_DEPENDENCIES_DEBUG}"
                                  "debug" libxslt)
    set(_CONAN_PKG_LIBS_LIBXSLT_DEPENDENCIES_RELEASE "${CONAN_SYSTEM_LIBS_LIBXSLT_RELEASE} ${CONAN_FRAMEWORKS_FOUND_LIBXSLT_RELEASE} CONAN_PKG::libxml2")
    string(REPLACE " " ";" _CONAN_PKG_LIBS_LIBXSLT_DEPENDENCIES_RELEASE "${_CONAN_PKG_LIBS_LIBXSLT_DEPENDENCIES_RELEASE}")
    conan_package_library_targets("${CONAN_PKG_LIBS_LIBXSLT_RELEASE}" "${CONAN_LIB_DIRS_LIBXSLT_RELEASE}"
                                  CONAN_PACKAGE_TARGETS_LIBXSLT_RELEASE "${_CONAN_PKG_LIBS_LIBXSLT_DEPENDENCIES_RELEASE}"
                                  "release" libxslt)
    set(_CONAN_PKG_LIBS_LIBXSLT_DEPENDENCIES_RELWITHDEBINFO "${CONAN_SYSTEM_LIBS_LIBXSLT_RELWITHDEBINFO} ${CONAN_FRAMEWORKS_FOUND_LIBXSLT_RELWITHDEBINFO} CONAN_PKG::libxml2")
    string(REPLACE " " ";" _CONAN_PKG_LIBS_LIBXSLT_DEPENDENCIES_RELWITHDEBINFO "${_CONAN_PKG_LIBS_LIBXSLT_DEPENDENCIES_RELWITHDEBINFO}")
    conan_package_library_targets("${CONAN_PKG_LIBS_LIBXSLT_RELWITHDEBINFO}" "${CONAN_LIB_DIRS_LIBXSLT_RELWITHDEBINFO}"
                                  CONAN_PACKAGE_TARGETS_LIBXSLT_RELWITHDEBINFO "${_CONAN_PKG_LIBS_LIBXSLT_DEPENDENCIES_RELWITHDEBINFO}"
                                  "relwithdebinfo" libxslt)
    set(_CONAN_PKG_LIBS_LIBXSLT_DEPENDENCIES_MINSIZEREL "${CONAN_SYSTEM_LIBS_LIBXSLT_MINSIZEREL} ${CONAN_FRAMEWORKS_FOUND_LIBXSLT_MINSIZEREL} CONAN_PKG::libxml2")
    string(REPLACE " " ";" _CONAN_PKG_LIBS_LIBXSLT_DEPENDENCIES_MINSIZEREL "${_CONAN_PKG_LIBS_LIBXSLT_DEPENDENCIES_MINSIZEREL}")
    conan_package_library_targets("${CONAN_PKG_LIBS_LIBXSLT_MINSIZEREL}" "${CONAN_LIB_DIRS_LIBXSLT_MINSIZEREL}"
                                  CONAN_PACKAGE_TARGETS_LIBXSLT_MINSIZEREL "${_CONAN_PKG_LIBS_LIBXSLT_DEPENDENCIES_MINSIZEREL}"
                                  "minsizerel" libxslt)

    add_library(CONAN_PKG::libxslt INTERFACE IMPORTED)

    # Property INTERFACE_LINK_FLAGS do not work, necessary to add to INTERFACE_LINK_LIBRARIES
    set_property(TARGET CONAN_PKG::libxslt PROPERTY INTERFACE_LINK_LIBRARIES ${CONAN_PACKAGE_TARGETS_LIBXSLT} ${_CONAN_PKG_LIBS_LIBXSLT_DEPENDENCIES}
                                                                 $<$<STREQUAL:$<TARGET_PROPERTY:TYPE>,SHARED_LIBRARY>:${CONAN_SHARED_LINKER_FLAGS_LIBXSLT_LIST}>
                                                                 $<$<STREQUAL:$<TARGET_PROPERTY:TYPE>,MODULE_LIBRARY>:${CONAN_SHARED_LINKER_FLAGS_LIBXSLT_LIST}>
                                                                 $<$<STREQUAL:$<TARGET_PROPERTY:TYPE>,EXECUTABLE>:${CONAN_EXE_LINKER_FLAGS_LIBXSLT_LIST}>

                                                                 $<$<CONFIG:Release>:${CONAN_PACKAGE_TARGETS_LIBXSLT_RELEASE} ${_CONAN_PKG_LIBS_LIBXSLT_DEPENDENCIES_RELEASE}
                                                                 $<$<STREQUAL:$<TARGET_PROPERTY:TYPE>,SHARED_LIBRARY>:${CONAN_SHARED_LINKER_FLAGS_LIBXSLT_RELEASE_LIST}>
                                                                 $<$<STREQUAL:$<TARGET_PROPERTY:TYPE>,MODULE_LIBRARY>:${CONAN_SHARED_LINKER_FLAGS_LIBXSLT_RELEASE_LIST}>
                                                                 $<$<STREQUAL:$<TARGET_PROPERTY:TYPE>,EXECUTABLE>:${CONAN_EXE_LINKER_FLAGS_LIBXSLT_RELEASE_LIST}>>

                                                                 $<$<CONFIG:RelWithDebInfo>:${CONAN_PACKAGE_TARGETS_LIBXSLT_RELWITHDEBINFO} ${_CONAN_PKG_LIBS_LIBXSLT_DEPENDENCIES_RELWITHDEBINFO}
                                                                 $<$<STREQUAL:$<TARGET_PROPERTY:TYPE>,SHARED_LIBRARY>:${CONAN_SHARED_LINKER_FLAGS_LIBXSLT_RELWITHDEBINFO_LIST}>
                                                                 $<$<STREQUAL:$<TARGET_PROPERTY:TYPE>,MODULE_LIBRARY>:${CONAN_SHARED_LINKER_FLAGS_LIBXSLT_RELWITHDEBINFO_LIST}>
                                                                 $<$<STREQUAL:$<TARGET_PROPERTY:TYPE>,EXECUTABLE>:${CONAN_EXE_LINKER_FLAGS_LIBXSLT_RELWITHDEBINFO_LIST}>>

                                                                 $<$<CONFIG:MinSizeRel>:${CONAN_PACKAGE_TARGETS_LIBXSLT_MINSIZEREL} ${_CONAN_PKG_LIBS_LIBXSLT_DEPENDENCIES_MINSIZEREL}
                                                                 $<$<STREQUAL:$<TARGET_PROPERTY:TYPE>,SHARED_LIBRARY>:${CONAN_SHARED_LINKER_FLAGS_LIBXSLT_MINSIZEREL_LIST}>
                                                                 $<$<STREQUAL:$<TARGET_PROPERTY:TYPE>,MODULE_LIBRARY>:${CONAN_SHARED_LINKER_FLAGS_LIBXSLT_MINSIZEREL_LIST}>
                                                                 $<$<STREQUAL:$<TARGET_PROPERTY:TYPE>,EXECUTABLE>:${CONAN_EXE_LINKER_FLAGS_LIBXSLT_MINSIZEREL_LIST}>>

                                                                 $<$<CONFIG:Debug>:${CONAN_PACKAGE_TARGETS_LIBXSLT_DEBUG} ${_CONAN_PKG_LIBS_LIBXSLT_DEPENDENCIES_DEBUG}
                                                                 $<$<STREQUAL:$<TARGET_PROPERTY:TYPE>,SHARED_LIBRARY>:${CONAN_SHARED_LINKER_FLAGS_LIBXSLT_DEBUG_LIST}>
                                                                 $<$<STREQUAL:$<TARGET_PROPERTY:TYPE>,MODULE_LIBRARY>:${CONAN_SHARED_LINKER_FLAGS_LIBXSLT_DEBUG_LIST}>
                                                                 $<$<STREQUAL:$<TARGET_PROPERTY:TYPE>,EXECUTABLE>:${CONAN_EXE_LINKER_FLAGS_LIBXSLT_DEBUG_LIST}>>)
    set_property(TARGET CONAN_PKG::libxslt PROPERTY INTERFACE_INCLUDE_DIRECTORIES ${CONAN_INCLUDE_DIRS_LIBXSLT}
                                                                      $<$<CONFIG:Release>:${CONAN_INCLUDE_DIRS_LIBXSLT_RELEASE}>
                                                                      $<$<CONFIG:RelWithDebInfo>:${CONAN_INCLUDE_DIRS_LIBXSLT_RELWITHDEBINFO}>
                                                                      $<$<CONFIG:MinSizeRel>:${CONAN_INCLUDE_DIRS_LIBXSLT_MINSIZEREL}>
                                                                      $<$<CONFIG:Debug>:${CONAN_INCLUDE_DIRS_LIBXSLT_DEBUG}>)
    set_property(TARGET CONAN_PKG::libxslt PROPERTY INTERFACE_COMPILE_DEFINITIONS ${CONAN_COMPILE_DEFINITIONS_LIBXSLT}
                                                                      $<$<CONFIG:Release>:${CONAN_COMPILE_DEFINITIONS_LIBXSLT_RELEASE}>
                                                                      $<$<CONFIG:RelWithDebInfo>:${CONAN_COMPILE_DEFINITIONS_LIBXSLT_RELWITHDEBINFO}>
                                                                      $<$<CONFIG:MinSizeRel>:${CONAN_COMPILE_DEFINITIONS_LIBXSLT_MINSIZEREL}>
                                                                      $<$<CONFIG:Debug>:${CONAN_COMPILE_DEFINITIONS_LIBXSLT_DEBUG}>)
    set_property(TARGET CONAN_PKG::libxslt PROPERTY INTERFACE_COMPILE_OPTIONS ${CONAN_C_FLAGS_LIBXSLT_LIST} ${CONAN_CXX_FLAGS_LIBXSLT_LIST}
                                                                  $<$<CONFIG:Release>:${CONAN_C_FLAGS_LIBXSLT_RELEASE_LIST} ${CONAN_CXX_FLAGS_LIBXSLT_RELEASE_LIST}>
                                                                  $<$<CONFIG:RelWithDebInfo>:${CONAN_C_FLAGS_LIBXSLT_RELWITHDEBINFO_LIST} ${CONAN_CXX_FLAGS_LIBXSLT_RELWITHDEBINFO_LIST}>
                                                                  $<$<CONFIG:MinSizeRel>:${CONAN_C_FLAGS_LIBXSLT_MINSIZEREL_LIST} ${CONAN_CXX_FLAGS_LIBXSLT_MINSIZEREL_LIST}>
                                                                  $<$<CONFIG:Debug>:${CONAN_C_FLAGS_LIBXSLT_DEBUG_LIST}  ${CONAN_CXX_FLAGS_LIBXSLT_DEBUG_LIST}>)


    set(_CONAN_PKG_LIBS_LIBARCHIVE_DEPENDENCIES "${CONAN_SYSTEM_LIBS_LIBARCHIVE} ${CONAN_FRAMEWORKS_FOUND_LIBARCHIVE} CONAN_PKG::zlib CONAN_PKG::libiconv")
    string(REPLACE " " ";" _CONAN_PKG_LIBS_LIBARCHIVE_DEPENDENCIES "${_CONAN_PKG_LIBS_LIBARCHIVE_DEPENDENCIES}")
    conan_package_library_targets("${CONAN_PKG_LIBS_LIBARCHIVE}" "${CONAN_LIB_DIRS_LIBARCHIVE}"
                                  CONAN_PACKAGE_TARGETS_LIBARCHIVE "${_CONAN_PKG_LIBS_LIBARCHIVE_DEPENDENCIES}"
                                  "" libarchive)
    set(_CONAN_PKG_LIBS_LIBARCHIVE_DEPENDENCIES_DEBUG "${CONAN_SYSTEM_LIBS_LIBARCHIVE_DEBUG} ${CONAN_FRAMEWORKS_FOUND_LIBARCHIVE_DEBUG} CONAN_PKG::zlib CONAN_PKG::libiconv")
    string(REPLACE " " ";" _CONAN_PKG_LIBS_LIBARCHIVE_DEPENDENCIES_DEBUG "${_CONAN_PKG_LIBS_LIBARCHIVE_DEPENDENCIES_DEBUG}")
    conan_package_library_targets("${CONAN_PKG_LIBS_LIBARCHIVE_DEBUG}" "${CONAN_LIB_DIRS_LIBARCHIVE_DEBUG}"
                                  CONAN_PACKAGE_TARGETS_LIBARCHIVE_DEBUG "${_CONAN_PKG_LIBS_LIBARCHIVE_DEPENDENCIES_DEBUG}"
                                  "debug" libarchive)
    set(_CONAN_PKG_LIBS_LIBARCHIVE_DEPENDENCIES_RELEASE "${CONAN_SYSTEM_LIBS_LIBARCHIVE_RELEASE} ${CONAN_FRAMEWORKS_FOUND_LIBARCHIVE_RELEASE} CONAN_PKG::zlib CONAN_PKG::libiconv")
    string(REPLACE " " ";" _CONAN_PKG_LIBS_LIBARCHIVE_DEPENDENCIES_RELEASE "${_CONAN_PKG_LIBS_LIBARCHIVE_DEPENDENCIES_RELEASE}")
    conan_package_library_targets("${CONAN_PKG_LIBS_LIBARCHIVE_RELEASE}" "${CONAN_LIB_DIRS_LIBARCHIVE_RELEASE}"
                                  CONAN_PACKAGE_TARGETS_LIBARCHIVE_RELEASE "${_CONAN_PKG_LIBS_LIBARCHIVE_DEPENDENCIES_RELEASE}"
                                  "release" libarchive)
    set(_CONAN_PKG_LIBS_LIBARCHIVE_DEPENDENCIES_RELWITHDEBINFO "${CONAN_SYSTEM_LIBS_LIBARCHIVE_RELWITHDEBINFO} ${CONAN_FRAMEWORKS_FOUND_LIBARCHIVE_RELWITHDEBINFO} CONAN_PKG::zlib CONAN_PKG::libiconv")
    string(REPLACE " " ";" _CONAN_PKG_LIBS_LIBARCHIVE_DEPENDENCIES_RELWITHDEBINFO "${_CONAN_PKG_LIBS_LIBARCHIVE_DEPENDENCIES_RELWITHDEBINFO}")
    conan_package_library_targets("${CONAN_PKG_LIBS_LIBARCHIVE_RELWITHDEBINFO}" "${CONAN_LIB_DIRS_LIBARCHIVE_RELWITHDEBINFO}"
                                  CONAN_PACKAGE_TARGETS_LIBARCHIVE_RELWITHDEBINFO "${_CONAN_PKG_LIBS_LIBARCHIVE_DEPENDENCIES_RELWITHDEBINFO}"
                                  "relwithdebinfo" libarchive)
    set(_CONAN_PKG_LIBS_LIBARCHIVE_DEPENDENCIES_MINSIZEREL "${CONAN_SYSTEM_LIBS_LIBARCHIVE_MINSIZEREL} ${CONAN_FRAMEWORKS_FOUND_LIBARCHIVE_MINSIZEREL} CONAN_PKG::zlib CONAN_PKG::libiconv")
    string(REPLACE " " ";" _CONAN_PKG_LIBS_LIBARCHIVE_DEPENDENCIES_MINSIZEREL "${_CONAN_PKG_LIBS_LIBARCHIVE_DEPENDENCIES_MINSIZEREL}")
    conan_package_library_targets("${CONAN_PKG_LIBS_LIBARCHIVE_MINSIZEREL}" "${CONAN_LIB_DIRS_LIBARCHIVE_MINSIZEREL}"
                                  CONAN_PACKAGE_TARGETS_LIBARCHIVE_MINSIZEREL "${_CONAN_PKG_LIBS_LIBARCHIVE_DEPENDENCIES_MINSIZEREL}"
                                  "minsizerel" libarchive)

    add_library(CONAN_PKG::libarchive INTERFACE IMPORTED)

    # Property INTERFACE_LINK_FLAGS do not work, necessary to add to INTERFACE_LINK_LIBRARIES
    set_property(TARGET CONAN_PKG::libarchive PROPERTY INTERFACE_LINK_LIBRARIES ${CONAN_PACKAGE_TARGETS_LIBARCHIVE} ${_CONAN_PKG_LIBS_LIBARCHIVE_DEPENDENCIES}
                                                                 $<$<STREQUAL:$<TARGET_PROPERTY:TYPE>,SHARED_LIBRARY>:${CONAN_SHARED_LINKER_FLAGS_LIBARCHIVE_LIST}>
                                                                 $<$<STREQUAL:$<TARGET_PROPERTY:TYPE>,MODULE_LIBRARY>:${CONAN_SHARED_LINKER_FLAGS_LIBARCHIVE_LIST}>
                                                                 $<$<STREQUAL:$<TARGET_PROPERTY:TYPE>,EXECUTABLE>:${CONAN_EXE_LINKER_FLAGS_LIBARCHIVE_LIST}>

                                                                 $<$<CONFIG:Release>:${CONAN_PACKAGE_TARGETS_LIBARCHIVE_RELEASE} ${_CONAN_PKG_LIBS_LIBARCHIVE_DEPENDENCIES_RELEASE}
                                                                 $<$<STREQUAL:$<TARGET_PROPERTY:TYPE>,SHARED_LIBRARY>:${CONAN_SHARED_LINKER_FLAGS_LIBARCHIVE_RELEASE_LIST}>
                                                                 $<$<STREQUAL:$<TARGET_PROPERTY:TYPE>,MODULE_LIBRARY>:${CONAN_SHARED_LINKER_FLAGS_LIBARCHIVE_RELEASE_LIST}>
                                                                 $<$<STREQUAL:$<TARGET_PROPERTY:TYPE>,EXECUTABLE>:${CONAN_EXE_LINKER_FLAGS_LIBARCHIVE_RELEASE_LIST}>>

                                                                 $<$<CONFIG:RelWithDebInfo>:${CONAN_PACKAGE_TARGETS_LIBARCHIVE_RELWITHDEBINFO} ${_CONAN_PKG_LIBS_LIBARCHIVE_DEPENDENCIES_RELWITHDEBINFO}
                                                                 $<$<STREQUAL:$<TARGET_PROPERTY:TYPE>,SHARED_LIBRARY>:${CONAN_SHARED_LINKER_FLAGS_LIBARCHIVE_RELWITHDEBINFO_LIST}>
                                                                 $<$<STREQUAL:$<TARGET_PROPERTY:TYPE>,MODULE_LIBRARY>:${CONAN_SHARED_LINKER_FLAGS_LIBARCHIVE_RELWITHDEBINFO_LIST}>
                                                                 $<$<STREQUAL:$<TARGET_PROPERTY:TYPE>,EXECUTABLE>:${CONAN_EXE_LINKER_FLAGS_LIBARCHIVE_RELWITHDEBINFO_LIST}>>

                                                                 $<$<CONFIG:MinSizeRel>:${CONAN_PACKAGE_TARGETS_LIBARCHIVE_MINSIZEREL} ${_CONAN_PKG_LIBS_LIBARCHIVE_DEPENDENCIES_MINSIZEREL}
                                                                 $<$<STREQUAL:$<TARGET_PROPERTY:TYPE>,SHARED_LIBRARY>:${CONAN_SHARED_LINKER_FLAGS_LIBARCHIVE_MINSIZEREL_LIST}>
                                                                 $<$<STREQUAL:$<TARGET_PROPERTY:TYPE>,MODULE_LIBRARY>:${CONAN_SHARED_LINKER_FLAGS_LIBARCHIVE_MINSIZEREL_LIST}>
                                                                 $<$<STREQUAL:$<TARGET_PROPERTY:TYPE>,EXECUTABLE>:${CONAN_EXE_LINKER_FLAGS_LIBARCHIVE_MINSIZEREL_LIST}>>

                                                                 $<$<CONFIG:Debug>:${CONAN_PACKAGE_TARGETS_LIBARCHIVE_DEBUG} ${_CONAN_PKG_LIBS_LIBARCHIVE_DEPENDENCIES_DEBUG}
                                                                 $<$<STREQUAL:$<TARGET_PROPERTY:TYPE>,SHARED_LIBRARY>:${CONAN_SHARED_LINKER_FLAGS_LIBARCHIVE_DEBUG_LIST}>
                                                                 $<$<STREQUAL:$<TARGET_PROPERTY:TYPE>,MODULE_LIBRARY>:${CONAN_SHARED_LINKER_FLAGS_LIBARCHIVE_DEBUG_LIST}>
                                                                 $<$<STREQUAL:$<TARGET_PROPERTY:TYPE>,EXECUTABLE>:${CONAN_EXE_LINKER_FLAGS_LIBARCHIVE_DEBUG_LIST}>>)
    set_property(TARGET CONAN_PKG::libarchive PROPERTY INTERFACE_INCLUDE_DIRECTORIES ${CONAN_INCLUDE_DIRS_LIBARCHIVE}
                                                                      $<$<CONFIG:Release>:${CONAN_INCLUDE_DIRS_LIBARCHIVE_RELEASE}>
                                                                      $<$<CONFIG:RelWithDebInfo>:${CONAN_INCLUDE_DIRS_LIBARCHIVE_RELWITHDEBINFO}>
                                                                      $<$<CONFIG:MinSizeRel>:${CONAN_INCLUDE_DIRS_LIBARCHIVE_MINSIZEREL}>
                                                                      $<$<CONFIG:Debug>:${CONAN_INCLUDE_DIRS_LIBARCHIVE_DEBUG}>)
    set_property(TARGET CONAN_PKG::libarchive PROPERTY INTERFACE_COMPILE_DEFINITIONS ${CONAN_COMPILE_DEFINITIONS_LIBARCHIVE}
                                                                      $<$<CONFIG:Release>:${CONAN_COMPILE_DEFINITIONS_LIBARCHIVE_RELEASE}>
                                                                      $<$<CONFIG:RelWithDebInfo>:${CONAN_COMPILE_DEFINITIONS_LIBARCHIVE_RELWITHDEBINFO}>
                                                                      $<$<CONFIG:MinSizeRel>:${CONAN_COMPILE_DEFINITIONS_LIBARCHIVE_MINSIZEREL}>
                                                                      $<$<CONFIG:Debug>:${CONAN_COMPILE_DEFINITIONS_LIBARCHIVE_DEBUG}>)
    set_property(TARGET CONAN_PKG::libarchive PROPERTY INTERFACE_COMPILE_OPTIONS ${CONAN_C_FLAGS_LIBARCHIVE_LIST} ${CONAN_CXX_FLAGS_LIBARCHIVE_LIST}
                                                                  $<$<CONFIG:Release>:${CONAN_C_FLAGS_LIBARCHIVE_RELEASE_LIST} ${CONAN_CXX_FLAGS_LIBARCHIVE_RELEASE_LIST}>
                                                                  $<$<CONFIG:RelWithDebInfo>:${CONAN_C_FLAGS_LIBARCHIVE_RELWITHDEBINFO_LIST} ${CONAN_CXX_FLAGS_LIBARCHIVE_RELWITHDEBINFO_LIST}>
                                                                  $<$<CONFIG:MinSizeRel>:${CONAN_C_FLAGS_LIBARCHIVE_MINSIZEREL_LIST} ${CONAN_CXX_FLAGS_LIBARCHIVE_MINSIZEREL_LIST}>
                                                                  $<$<CONFIG:Debug>:${CONAN_C_FLAGS_LIBARCHIVE_DEBUG_LIST}  ${CONAN_CXX_FLAGS_LIBARCHIVE_DEBUG_LIST}>)
    ...
    set(CONAN_TARGETS CONAN_PKG::pcre2 CONAN_PKG::libxslt CONAN_PKG::libarchive CONAN_PKG::bzip2 CONAN_PKG::libxml2 CONAN_PKG::zlib CONAN_PKG::libiconv)
